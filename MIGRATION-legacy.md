# Migration Guide (Legacy Archive)

Historical migration paths for envision upgrades **from v0.13.x and earlier**. Migration entries for v0.14.0 onward live in [`MIGRATION.md`](MIGRATION.md).

Split from the main `MIGRATION.md` on 2026-07-05 to keep the primary file under the project's 1000-line file-size cap. See `docs/audits/2026-07-05-post-doc-hygiene.md` for the closure record.
