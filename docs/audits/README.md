...
- [2026-07-26 post-cadence-d](2026-07-26-post-cadence-d.md) — closure record for Cadence D, the selection-accessor completion (spec PR #514, plan PR #515, impl PR #516). Closes the selection-accessor alias finding carried since the 2026-07-05 post-cleanup audit, plus naming outlier N3 (`tab_bar`) and the prelude harness-type gap Cadence A's final review raised. Net −52 lines; 12 aliases deleted, 4 primary accessors renamed, 12 setters renamed. Scorecard 9/9 with accessor symmetry gaps 0. Opens two new deferred findings — the untouched `with_selected` builder leg and three surviving `selected_item()` aliases — both consequences of this cadence's own scope boundary. No Fable re-audit; the next full audit should gate the v0.18.0 release.
