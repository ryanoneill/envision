//! ChartState accessors, setters, and instance methods.
//!
//! Extracted from `mod.rs` to keep file sizes manageable.

use super::{Chart, ChartKind, ChartMessage, ChartOutput, DataSeries, ThresholdLine, VerticalLine};
use crate::component::Component;
use crate::input::Event;

impl super::ChartState {
    // ---- Accessors ----
