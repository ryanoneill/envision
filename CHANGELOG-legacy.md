...
Historical release notes for envision versions **v0.14.x and earlier**. Entries for v0.15.0 onward live in [`CHANGELOG.md`](CHANGELOG.md).

Split from the main `CHANGELOG.md` on 2026-07-05 to keep the primary file under the project's 1000-line file-size cap. See `docs/audits/2026-07-05-post-doc-hygiene.md` for the closure record.
